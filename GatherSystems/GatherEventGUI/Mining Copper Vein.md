        ...
        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
            ...
            Then - Actions
                ...
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    ...
                    Then - Actions
                        -------- debug 1 --------
                        Hero - Create Copper Ore and give it to DamageEventSource
                        ...
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Malachite and give it to DamageEventSource
                            Else - Actions
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                        ...
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Tigerseye and give it to DamageEventSource
                            Else - Actions
                    Else - Actions
                -------- Ore gathered --------
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
