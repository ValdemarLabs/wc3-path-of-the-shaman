    ...
    Actions
        ...
        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
            ...
            Then - Actions
                ...
                -------- Mining chance --------
                Set VariableSet MiningChance = (Random integer number between 1 and 9)
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    If - Conditions
                ...
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    ...
                    Then - Actions
                        -------- debug 1 --------
                        Hero - Create Iron Ore and give it to DamageEventSource
                        Set VariableSet OreAmountArray[Temp_Ore] = (OreAmountArray[Temp_Ore] + 1)
                        -------- Gemstone chance --------
                        Set VariableSet MiningGemstoneChance = (Random integer number between 1 and 7)
                        -------- Gemstones --------
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Jade and give it to DamageEventSource
                            Else - Actions
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Citrine and give it to DamageEventSource
                            Else - Actions
                    Else - Actions
                -------- Ore gathered --------
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
