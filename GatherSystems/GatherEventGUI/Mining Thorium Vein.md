        ...
        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
            ...
            Then - Actions
                ...
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    ...
                    Then - Actions
                        -------- debug 1 --------
                        Hero - Create Thorium Ore and give it to DamageEventSource
                        ...
                        Set VariableSet MiningGemstoneChance2 = (Random integer number between 1 and 12)
                        -------- Gemstones --------
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                                    Conditions
                                        MiningGemstoneChance2 Equal to 1
                                        OreAmountArray[Temp_Ore] Less than OreAmountTotalArray[Temp_Ore]
                                        OreAmountTotalSet[Temp_Ore] Equal to True
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Arcane Crystal and give it to DamageEventSource
                            Else - Actions
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Diamond and give it to DamageEventSource
                            Else - Actions
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Emerald and give it to DamageEventSource
                            Else - Actions
                        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                            If - Conditions
                                And - All (Conditions) are true
                            ...
                            Then - Actions
                                -------- debug 1 --------
                                Hero - Create Blue Sapphire and give it to DamageEventSource
                            Else - Actions
                    Else - Actions
                -------- Ore gathered --------
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
