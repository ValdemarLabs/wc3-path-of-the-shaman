            ...
            Then - Actions
                ...
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    ...
                    Then - Actions
                        ...
                        Set VariableSet OreAmountTotalArray[Temp_Ore] = (Random integer number between 2 and 4)
                ...
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    ...
                    Then - Actions
                        -------- debug 1 --------
                        Hero - Create Yellow Crystal and give it to DamageEventSource
