...
library VendorCatalogs initializer Init requires Shop, VendorLines, VoicelinesVendorLines, Reputation
    ...
    private function ConfigureVendorNames takes nothing returns nothing
        ...
        call RegisterVendorName('n04W', "Korak Ironhorn")
        call RegisterVendorName('n04X', "Bovan Earthhide")
        call RegisterVendorName('n04Y', "Turog Stoneguard")
        call RegisterVendorName('n04Z', "Marn Thunderkettle")
        call RegisterVendorName('n050', "Doran Plainstrider")
        call RegisterVendorName('n051', "Kargan Redtotem")

        // Female Human vendors
        call RegisterVendorName('n052', "Mara Vane")
        call RegisterVendorName('n053', "Elayne Ward")
        call RegisterVendorName('n054', "Catrin Targe")
        call RegisterVendorName('n055', "Nora Flint")
        call RegisterVendorName('n056', "Elira Moss")
        call RegisterVendorName('n057', "Hester Bellows")
        call RegisterVendorName('n058', "Talia Tanner")
        call RegisterVendorName('n059', "Greta Stone")
        call RegisterVendorName('n05A', "Willa Hart")
        call RegisterVendorName('n05B', "Sabine Pike")
        call RegisterVendorName('n05C', "Maren Tidewell")
        call RegisterVendorName('n05D', "Odette Hearth")
        call RegisterVendorName('n05E', "Clara Bell")
        call RegisterVendorName('n05F', "Isolde Wren")
        call RegisterVendorName('n05G', "Fenna Reed")
        call RegisterVendorName('n05H', "Mira Salt")
        call RegisterVendorName('n05I', "Adele Shore")
        call RegisterVendorName('n05J', "Kessa Kane")
        call RegisterVendorName('n05K', "Elara Wayland")
        call RegisterVendorName('n05L', "Petra Crane")
        call RegisterVendorName('n05M', "Vianne Quill")
        call RegisterVendorName('n05N', "Celia Harrow")
        call RegisterVendorName('n05O', "Lenora Crow")
        call RegisterVendorName('n05P', "Roslyn Mercer")
    endfunction
