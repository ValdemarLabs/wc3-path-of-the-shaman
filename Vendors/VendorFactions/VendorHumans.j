...
library VendorHumans initializer Init requires VendorCatalogs
    ...
    private function Init takes nothing returns nothing
        ...
        call Register('n052', VendorCatalogs_VENDOR_CATALOG_WEAPONS, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n053', VendorCatalogs_VENDOR_CATALOG_ARMOR, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n054', VendorCatalogs_VENDOR_CATALOG_SHIELDS, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n055', VendorCatalogs_VENDOR_CATALOG_MINER, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n056', VendorCatalogs_VENDOR_CATALOG_ALCHEMY_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n057', VendorCatalogs_VENDOR_CATALOG_BLACKSMITHING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n058', VendorCatalogs_VENDOR_CATALOG_LEATHERWORKING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n059', VendorCatalogs_VENDOR_CATALOG_MINING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n05A', VendorCatalogs_VENDOR_CATALOG_SKINNING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)
        call Register('n05B', VendorCatalogs_VENDOR_CATALOG_QUARTERMASTER, VL_VENDOR_PROFILE_HUMAN_RIVERBANE_FEMALE)

        // Female Stormhaven merchants.
        call Register('n05C', VendorCatalogs_VENDOR_CATALOG_FISHER, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)
        call Register('n05D', VendorCatalogs_VENDOR_CATALOG_COOK, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)
        call Register('n05E', VendorCatalogs_VENDOR_CATALOG_COOKING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)
        call Register('n05F', VendorCatalogs_VENDOR_CATALOG_ENCHANTING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)
        call Register('n05G', VendorCatalogs_VENDOR_CATALOG_FISHING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)
        call Register('n05H', VendorCatalogs_VENDOR_CATALOG_REAGENTS, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)
        call Register('n05I', VendorCatalogs_VENDOR_CATALOG_FOOD_AND_DRINK, VL_VENDOR_PROFILE_HUMAN_STORMHAVEN_FEMALE)

        // Female neutral and travelling merchants.
        call Register('n05J', VendorCatalogs_VENDOR_CATALOG_ARENA, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
        call Register('n05K', VendorCatalogs_VENDOR_CATALOG_TRAVELLING, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
        call Register('n05L', VendorCatalogs_VENDOR_CATALOG_PROFESSION_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
        call Register('n05M', VendorCatalogs_VENDOR_CATALOG_RANDOMIZED_GOODS, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
        call Register('n05N', VendorCatalogs_VENDOR_CATALOG_POTIONS, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
        call Register('n05O', VendorCatalogs_VENDOR_CATALOG_RARE_GOODS, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
        call Register('n05P', VendorCatalogs_VENDOR_CATALOG_ADVENTURING_SUPPLIES, VL_VENDOR_PROFILE_HUMAN_NEUTRAL_FEMALE)
    endfunction
endlibrary
