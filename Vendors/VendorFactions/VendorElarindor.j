...
library VendorElarindor initializer Init requires VendorCatalogs
    ...
    private function Init takes nothing returns nothing
        call Register('h00L', VendorCatalogs_VENDOR_CATALOG_WEAPONS, VL_VENDOR_PROFILE_ELARINDOR_MALE)
        call Register('h00P', VendorCatalogs_VENDOR_CATALOG_ARMOR, VL_VENDOR_PROFILE_ELARINDOR_FEMALE)
        call Register('n00M', VendorCatalogs_VENDOR_CATALOG_SHIELDS, VL_VENDOR_PROFILE_ELARINDOR_MALE)
        call Register('h00Q', VendorCatalogs_VENDOR_CATALOG_ENCHANTING_SUPPLIES, VL_VENDOR_PROFILE_ELARINDOR_FEMALE)
        call Register('h00N', VendorCatalogs_VENDOR_CATALOG_REAGENTS, VL_VENDOR_PROFILE_ELARINDOR_MALE)
