...
library VendorElarindor initializer Init requires VendorCatalogs
    ...
    private function Init takes nothing returns nothing
        ...
        call Register('h00O', VendorCatalogs_VENDOR_CATALOG_ADVENTURING_SUPPLIES, VL_VENDOR_PROFILE_ELARINDOR_MALE, VL_GENERIC_ELARINDOR_MALE_2_TYPE)
        call Register('h00S', VendorCatalogs_VENDOR_CATALOG_QUARTERMASTER, VL_VENDOR_PROFILE_ELARINDOR_FEMALE, VL_GENERIC_ELARINDOR_FEMALE_2_TYPE)
        call Register('h011', VendorCatalogs_VENDOR_CATALOG_JEWELCRAFTER, VL_VENDOR_PROFILE_ELARINDOR_FEMALE, VL_GENERIC_ELARINDOR_FEMALE_1_TYPE)
        call Register('h012', VendorCatalogs_VENDOR_CATALOG_MAGISTER, VL_VENDOR_PROFILE_ELARINDOR_MALE, VL_GENERIC_ELARINDOR_MALE_1_TYPE)
    endfunction
endlibrary
