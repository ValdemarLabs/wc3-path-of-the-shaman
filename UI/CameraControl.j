...
public function Init takes nothing returns nothing
    ...
    loop
        ...
        call BlzTriggerRegisterPlayerKeyEvent(CC_RightUpTrigger, Player(i), OSKEY_RIGHT, 0, false)
        call BlzTriggerRegisterPlayerKeyEvent(CC_UpDownTrigger, Player(i), OSKEY_UP, 0, true)
        call BlzTriggerRegisterPlayerKeyEvent(CC_UpUpTrigger, Player(i), OSKEY_UP, 0, false)
        call BlzTriggerRegisterPlayerKeyEvent(CC_DownDownTrigger, Player(i), OSKEY_DOWN, 0, true)
        call BlzTriggerRegisterPlayerKeyEvent(CC_DownUpTrigger, Player(i), OSKEY_DOWN, 0, false)
