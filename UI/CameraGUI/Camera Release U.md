Camera Release U
    Events
        ...
        Player - Player 20 (Lavender) Releases the Up Arrow key
    Conditions
    Actions
        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
            ...
            Then - Actions
                ...
                Set VariableSet Camera_PressingU[CameraPlayerNumber] = False
                Set VariableSet Camera_MoveU[CameraPlayerNumber] = False
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    If - Conditions
                        Camera_PressingD[CameraPlayerNumber] Equal to True
                    Then - Actions
