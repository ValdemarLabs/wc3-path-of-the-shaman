Camera Release D
    Events
        ...
        Player - Player 20 (Lavender) Releases the Down Arrow key
    Conditions
    Actions
        If (All Conditions are True) then do (Then Actions) else do (Else Actions)
            ...
            Then - Actions
                ...
                Set VariableSet Camera_PressingD[CameraPlayerNumber] = False
                Set VariableSet Camera_MoveD[CameraPlayerNumber] = False
                If (All Conditions are True) then do (Then Actions) else do (Else Actions)
                    If - Conditions
                        Camera_PressingU[CameraPlayerNumber] Equal to True
                    Then - Actions
