...
library StatsLiteUI requires Table, MasterUI, QuestGiver, Companions, Pet, AI // CHANGE: use AI registry instead of legacy udg_NPC_Horde_AI_xxx globals
    globals
        ...
        private constant real SLUI_PANEL_WIDTH = 0.300
        private constant real SLUI_PANEL_MIN_HEIGHT = 0.104
        private constant real SLUI_PANEL_MAX_HEIGHT = 0.352
        private constant real SLUI_PANEL_CONFIG_HEIGHT = 0.280
        private constant real SLUI_PANEL_MINIMIZED_HEIGHT = 0.044
        private constant real SLUI_PANEL_BASE_HEIGHT = 0.062
        ...
        private constant integer SLUI_ACTION_ALERT_LOW_RESOURCE = 17 // CHANGE: config toggle for low mana alerts
        ...
        private constant integer SLUI_ACTION_SHOW_MODE = 21
        ...
        private constant integer SLUI_ALERT_LOW_RESOURCE = 2 // CHANGE: low mana
        ...
        private boolean SLUI_ShowMode = true
        private boolean SLUI_AlertLowHP = true // CHANGE: configurable low-health flash alert
        private boolean SLUI_AlertLowResource = true // CHANGE: configurable low mana flash alert
        ...
        private framehandle array SLUI_RowMode
        ...
        private real SLUI_RowAlertOffsetX = -0.008
        private real SLUI_RowAlertOffsetY = -0.008
    ...
    private function SLUI_GetCompanionModeText takes unit u, integer kind returns string
        ...
        if mode == 2 then
            return "|cffbfbfbfPassive|r"
        elseif mode == 3 then
            return "|cffffcc00Hold Position|r"
        elseif mode == 4 then
            return "|cffff8040Aggressive|r"
        endif
        return "|cff80ff80Normal|r"
    endfunction
    ...
    private function SLUI_GetRowAlertLevel takes unit u, integer kind, integer hp, integer mp, integer dead returns integer
        ...
        if SLUI_AlertLowResource and SLUI_HasResourceBar(u) and SLUI_GetResourceMode(u) == SLUI_RESOURCE_MANA and I2R(mp) <= SLUI_LOW_RESOURCE_ALERT_PERCENT then
    ...
    private function SLUI_UpdateRowFrame takes integer rowIndex, unit u, integer kind returns nothing
        ...
        if SLUI_ShowMode and kind == SLUI_KIND_COMPANION then
            ...
            if SLUI_RowModeCache[rowIndex] != modeText then
                ...
                call BlzFrameSetText(SLUI_RowMode[rowIndex], modeText)
            endif
        endif
    ...
    private function SLUI_UpdateConfig takes player whichPlayer returns nothing
        ...
        call BlzFrameSetText(SLUI_ConfigToggleButton[9], "Low Mana: " + SLUI_OnOff(SLUI_AlertLowResource))
        ...
        call BlzFrameSetText(SLUI_ConfigToggleButton[12], "Mode: " + SLUI_OnOff(SLUI_ShowMode))
        set whichPlayer = null
    endfunction
    ...
    private function SLUI_ButtonClickAction takes nothing returns nothing
        ...
        if SLUI_ButtonAction.has(handleId) then
            ...
            elseif actionId == SLUI_ACTION_SHOW_MODE then
                set SLUI_ShowMode = not SLUI_ShowMode
    ...
    private function SLUI_CreateRow takes integer rowIndex, real y returns nothing
        ...
        call BlzFrameSetPoint(SLUI_RowLevel[rowIndex], FRAMEPOINT_TOPLEFT, SLUI_RowIcon[rowIndex], FRAMEPOINT_TOPRIGHT, textGap, -0.018)
        call BlzFrameSetSize(SLUI_RowLevel[rowIndex], 0.060, 0.009)
        ...
        call BlzFrameSetPoint(SLUI_RowClass[rowIndex], FRAMEPOINT_TOPLEFT, SLUI_RowIcon[rowIndex], FRAMEPOINT_TOPRIGHT, textGap, -0.009)
        call BlzFrameSetSize(SLUI_RowClass[rowIndex], 0.066, 0.009)
        call BlzFrameSetTextAlignment(SLUI_RowClass[rowIndex], TEXT_JUSTIFY_MIDDLE, TEXT_JUSTIFY_LEFT)
        call BlzFrameSetScale(SLUI_RowClass[rowIndex], 0.50)
        ...
        call BlzFrameSetPoint(SLUI_RowState[rowIndex], FRAMEPOINT_TOPLEFT, SLUI_RowIcon[rowIndex], FRAMEPOINT_TOPRIGHT, textGap + stateOffset, -0.009)
        ...
        call BlzFrameSetEnable(SLUI_RowMode[rowIndex], false)
        call BlzFrameSetLevel(SLUI_RowMode[rowIndex], 4)
        ...
        call BlzFrameSetPoint(SLUI_RowMPBack[rowIndex], FRAMEPOINT_TOPLEFT, SLUI_RowHPBack[rowIndex], FRAMEPOINT_BOTTOMLEFT, 0.0, -0.003)
    ...
    private function SLUI_CreateFrames takes nothing returns nothing
        ...
        call SLUI_UpdateScreenAnchor()
        call BlzFrameSetEnable(SLUI_ScreenAnchor, false)
        call BlzFrameSetVisible(SLUI_ScreenAnchor, false)
        ...
        set SLUI_Parent = BlzCreateFrameByType("FRAME", "StatsLiteUIPanel", SLUI_ScreenParent, "", 0)
        call SLUI_SetPanelFrame(SLUI_PANEL_WIDTH, SLUI_GetPanelHeight())
        ...
        call SLUI_CreateConfigButton(9, "Low Mana", SLUI_ACTION_ALERT_LOW_RESOURCE, 0.010, -0.132) // CHANGE: low mana alert toggle
        ...
        call SLUI_CreateConfigButton(12, "Mode", SLUI_ACTION_SHOW_MODE, 0.130, -0.157)
