/**
    ...
    links. Talent reset is handled by trainer-only AbilityUI actions.
...
library TalentsUI initializer AutoInit requires Table, MasterUI, Talents, AbilitiesPlayer, Interface
    globals
        ...
        private string TUI_ElementalBackgroundTexture = "Art\\ShamanElemental.blp"
        private string TUI_EnhancementBackgroundTexture = "Art\\ShamanEnhancement.blp"
        private string TUI_RestorationBackgroundTexture = "Art\\ShamanRestoration.blp"
        private string TUI_TotemicBackgroundTexture = "Art\\ShamanTotemic.blp"
            ...
            loop
                ...
                if talentIndex != 0 then
                    ...
                    if TUI_TalentHighlightVisible[slotIndex] != selected then
                        ...
                        call TUI_SetTalentHighlightVisible(slotIndex, selected == 1)
                    endif
                else
    ...
    private function TUI_CreateFrames takes nothing returns nothing
        ...
        call BlzFrameSetPoint(TUI_CancelButton, FRAMEPOINT_BOTTOMLEFT, TUI_Parent, FRAMEPOINT_BOTTOMLEFT, 0.020, 0.018)
