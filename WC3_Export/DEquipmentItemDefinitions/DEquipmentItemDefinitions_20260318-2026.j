...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0b0', "Gloves")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0b4', "Gloves")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0c3', "Gloves")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0g3', "Gloves")
