...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    // |cFFFFFFFFTraveler's Journal|r (Common)
    // Base: dtsb, Class: Other
    ...
    // |cFFFFFFFFGoblin Rocket Fuel|r (Common)
    // Base: afac, Class: Material
    call DEqItemTypeDefineGoldValue('j4c2', 1000)

    // |cFFFFFFFFWorn Hexer's Hood|r (Common)
    // Base: rat9, Class: Head Armor
    call DEqItemTypeDefineAllowedSlotByName('j4c3', "Head")

    // |cFFFFFFFFSalt-Stained Ritual Vest|r (Common)
    // Base: rat9, Class: Chest Armor
    call DEqItemTypeDefineAllowedSlotByName('j4c4', "Chest")
    call DEqItemTypeDefineStatGrantedByName('j4c4', "Intelligence", 1)

    // |cFFFFFFFFFrayed Handwraps|r (Common)
    // Base: rat9, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('j4c5', "Gloves")

    // |cFFFFFFFFFetish-Keeper's Cord|r (Common)
    // Base: rat9, Class: Belt
    call DEqItemTypeDefineAllowedSlotByName('j4c6', "Belt")
    call DEqItemTypeDefineStatGrantedByName('j4c6', "Mana", 5)

    // |cFFFFFFFFRiverworn Kilt|r (Common)
    // Base: rat9, Class: Leg Armor
    call DEqItemTypeDefineAllowedSlotByName('j4c7', "Legs")

    // |cFFFFFFFFReedbound Sandals|r (Common)
    // Base: rat9, Class: Foot Armor
    call DEqItemTypeDefineAllowedSlotByName('j4c8', "Boots")

    // |cFFFFFFFFDarkspear Bone Beads|r (Common)
    // Base: rat9, Class: Neck
    call DEqItemTypeDefineAllowedSlotByName('j4c9', "Neck")
    call DEqItemTypeDefineStatGrantedByName('j4c9', "Spell Power", 1)

    // |cFFFFFFFFFaded Mojo Charm|r (Common)
    // Base: rat9, Class: Trinket
    call DEqItemTypeDefineAllowedSlotId('j4d0', 17)
    call DEqItemTypeDefineAllowedSlotId('j4d0', 18)
