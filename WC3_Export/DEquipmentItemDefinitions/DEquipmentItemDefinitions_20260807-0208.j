...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    call DEqItemTypeDefineStatGrantedByName('j4b1', "Mana Pct Per Sec", 1)
    ...
    call DEqItemTypeDefineStatGrantedByName('j4b9', "Mana Pct Per Sec", 1)
