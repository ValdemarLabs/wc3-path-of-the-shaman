...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    // Base: bzbe, Class: Two-Hand Weapon
    call DEqItemTypeDefineAllowedSlotId('I6CQ', 19)
    ...
    // Base: bzbe, Class: Two-Hand Weapon
    call DEqItemTypeDefineAllowedSlotId('I6CR', 19)
    ...
    // Base: bzbe, Class: Two-Hand Weapon
    call DEqItemTypeDefineAllowedSlotId('I6CS', 19)
    ...
    // Base: bzbe, Class: Two-Hand Weapon
    call DEqItemTypeDefineAllowedSlotId('I6CT', 19)
