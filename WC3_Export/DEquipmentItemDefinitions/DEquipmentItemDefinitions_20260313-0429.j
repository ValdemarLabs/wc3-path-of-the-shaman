...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0a0', "Hands")

    // Rusty 1h of the Ancients (Epic)
    // Base: sman, Class: 1h
    call DEqItemTypeDefineGoldValue('i0a1', 73000)

    // Charred Bone (Common)
    // Base: wolg, Class: Miscellaneous
    call DEqItemTypeDefineGoldValue('i0a2', 2)

    // Mystical Shadow Essence (Epic)
    // Base: pnvu, Class: QUEST
    call DEqItemTypeDefineGoldValue('i0a3', 75)

    // Ragnaros Test Hammer 1234 (Legendary)
    // Base: bspd, Class: Two-Hand Weapon
    call DEqItemTypeDefineAllowedSlotByName('i0a4', "Hands")
    call DEqItemTypeDefineGoldValue('i0a4', 5125)

    // TEST Blade of the Titan (Rare)
    // Base: very, Class: Two-Hand Weapon
    call DEqItemTypeDefineAllowedSlotByName('i0a5', "Hands")
    call DEqItemTypeDefineGoldValue('i0a5', 38500)

    // |c00FFFFFFIcon tester|r (Common)
    // Base: bspd, Class: 1h
    ...
    // Murloc Head (Common)
    // Base: kybl, Class: CONSUMABLE

    // Camp Fire (Common)
    // Base: tgrh, Class: CONSUMABLE
    ...
    // TEST_BELT_666 (Rare)
    // Base: belv, Class: Belt
    call DEqItemTypeDefineAllowedSlotByName('i900', "Belt")
    call DEqItemTypeDefineGoldValue('i900', 666)
    ...
    // Base: pinv, Class: CONSUMABLE

    // Unknown Item (plcl) (Common)
    // Base: plcl, Class: CONSUMABLE
    ...
    // Base: scul, Class: CONSUMABLE

    // Unknown Item (shas) (Common)
    // Base: shas, Class: CONSUMABLE
    ...
    // Base: ssan, Class: CONSUMABLE

    // Unknown Item (stwp) (Common)
    // Base: stwp, Class: CONSUMABLE
    ...
    // Base: tret, Class: CONSUMABLE

    // Unknown Item (vamp) (Common)
    // Base: vamp, Class: CONSUMABLE
