...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    // |cFFFFFFFFPrimal Force|r (Common)
    // Base: tdex, Class: Ability
    ...
    call DEqItemTypeDefineStatGrantedByName('i0a7', "Agility", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0a7', "Armor", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0a7', "Health", 57.00)
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0a8', "Ring")
    call DEqItemTypeDefineStatGrantedByName('i0a8', "Agility", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0a8', "Intelligence", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0a8', "Lifesteal", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0a8', "Strength", 13.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0a9', "Armor", 6.00)
    call DEqItemTypeDefineStatGrantedByName('i0a9', "Health", 63.00)
    call DEqItemTypeDefineStatGrantedByName('i0a9', "Intelligence", 14.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b0', "Agility", 26.00)
    call DEqItemTypeDefineStatGrantedByName('i0b0', "Armor", 11.00)
    call DEqItemTypeDefineStatGrantedByName('i0b0', "Health", 113.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b1', "Armor", 9.00)
    call DEqItemTypeDefineStatGrantedByName('i0b1', "Health", 95.00)
    call DEqItemTypeDefineStatGrantedByName('i0b1', "Strength", 22.00)
    call DEqItemTypeDefineGoldValue('i0b1', 14000)

    // |c00FFFFFFQuality reserved_4 of Protection|r (Common)
    // Base: gold, Class: reserved_4
    call DEqItemTypeDefineStatGrantedByName('i0b2', "Agility", 4.00)
    call DEqItemTypeDefineStatGrantedByName('i0b2', "Health", 24.00)
    call DEqItemTypeDefineStatGrantedByName('i0b2', "Strength", 4.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b3', "Armor", 19.00)
    call DEqItemTypeDefineStatGrantedByName('i0b3', "Health", 199.00)
    call DEqItemTypeDefineStatGrantedByName('i0b3', "HPS", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0b3', "Strength", 46.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b4', "Agility", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0b4', "Armor", 4.00)
    call DEqItemTypeDefineStatGrantedByName('i0b4', "Cleave Pct", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0b4', "Critical Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0b4', "Health", 44.00)
    call DEqItemTypeDefineStatGrantedByName('i0b4', "Sight Range", 6.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b5', "Agility", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0b5', "Critical Chance", 1.00)
    call DEqItemTypeDefineStatGrantedByName('i0b5', "Intelligence", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0b5', "Strength", 10.00)
    call DEqItemTypeDefineGoldValue('i0b5', 8500)

    // |c001EFF00Reliable reserved_1 of Power|r (Uncommon)
    // Base: gold, Class: reserved_1
    call DEqItemTypeDefineStatGrantedByName('i0b6', "Agility", 7.00)
    call DEqItemTypeDefineStatGrantedByName('i0b6', "Critical Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0b6', "Health", 38.00)
    call DEqItemTypeDefineStatGrantedByName('i0b6', "Strength", 7.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b7', "Armor", 17.00)
    call DEqItemTypeDefineStatGrantedByName('i0b7', "Critical Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0b7', "Health", 176.00)
    call DEqItemTypeDefineStatGrantedByName('i0b7', "Movement Speed", 11.00)
    call DEqItemTypeDefineStatGrantedByName('i0b7', "Strength", 41.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0b8', "Agility", 24.00)
    call DEqItemTypeDefineStatGrantedByName('i0b8', "Critical Chance", 25.00)
    call DEqItemTypeDefineStatGrantedByName('i0b8', "Intelligence", 24.00)
    call DEqItemTypeDefineStatGrantedByName('i0b8', "Movement Speed", 12.00)
    call DEqItemTypeDefineStatGrantedByName('i0b8', "Strength", 24.00)
    call DEqItemTypeDefineGoldValue('i0b8', 38000)

    // |c001EFF00Sturdy Stave of the Bear|r (Uncommon)
    // Base: rej1, Class: Stave
    call DEqItemTypeDefineStatGrantedByName('i0b9', "Attack Speed", 15.00)
    call DEqItemTypeDefineStatGrantedByName('i0b9', "Critical Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0b9', "Damage", 39.00)
    call DEqItemTypeDefineStatGrantedByName('i0b9', "Dodge", 1.00)
    call DEqItemTypeDefineStatGrantedByName('i0b9', "Hit Chance", 35.00)
    call DEqItemTypeDefineStatGrantedByName('i0b9', "Intelligence", 27.00)
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0c0', "Gloves")
    call DEqItemTypeDefineStatGrantedByName('i0c0', "Armor", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c0', "Health", 58.00)
    call DEqItemTypeDefineStatGrantedByName('i0c0', "Strength", 13.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c1', "Armor", 4.00)
    call DEqItemTypeDefineStatGrantedByName('i0c1', "Critical Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c1', "Health", 48.00)
    call DEqItemTypeDefineStatGrantedByName('i0c1', "Hit Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c1', "Strength", 12.00)
    call DEqItemTypeDefineGoldValue('i0c1', 3000)

    // |c00A335EESturdy Stave of Eternity|r (Epic)
    // Base: rej4, Class: Stave
    call DEqItemTypeDefineStatGrantedByName('i0c2', "Attack Speed", 31.00)
    call DEqItemTypeDefineStatGrantedByName('i0c2', "Damage", 79.00)
    call DEqItemTypeDefineStatGrantedByName('i0c2', "Hit Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c2', "Intelligence", 55.00)
    call DEqItemTypeDefineStatGrantedByName('i0c2', "Movement Speed", 15.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c3', "Armor", 15.00)
    call DEqItemTypeDefineStatGrantedByName('i0c3', "Health", 152.00)
    call DEqItemTypeDefineStatGrantedByName('i0c3', "Strength", 35.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c4', "Agility", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0c4', "Intelligence", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0c4', "Strength", 10.00)
    call DEqItemTypeDefineGoldValue('i0c4', 7250)

    // |c001EFF00Sturdy Other of the Bear|r (Uncommon)
    // Base: afac, Class: Other
    call DEqItemTypeDefineStatGrantedByName('i0c5', "Agility", 8.00)
    call DEqItemTypeDefineStatGrantedByName('i0c5', "Hit Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c5', "Strength", 8.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c6', "Hit Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c6', "Strength", 10.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c7', "Critical Chance", 15.00)
    call DEqItemTypeDefineStatGrantedByName('i0c7', "Damage", 36.00)
    call DEqItemTypeDefineStatGrantedByName('i0c7', "Strength", 25.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c8', "Agility", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0c8', "Critical Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c8', "Hit Chance", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0c8', "Intelligence", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0c8', "Strength", 10.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0c9', "Agility", 14.00)
    call DEqItemTypeDefineStatGrantedByName('i0c9', "Health", 74.00)
    call DEqItemTypeDefineStatGrantedByName('i0c9', "Mana Regen Per Sec", 7.00)
    call DEqItemTypeDefineStatGrantedByName('i0c9', "Strength", 14.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d0', "Agility", 34.00)
    call DEqItemTypeDefineStatGrantedByName('i0d0', "Armor", 14.00)
    call DEqItemTypeDefineStatGrantedByName('i0d0', "Health", 149.00)
    call DEqItemTypeDefineStatGrantedByName('i0d0', "Mana Regen Per Sec", 9.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d1', "Armor", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i0d1', "Health", 57.00)
    call DEqItemTypeDefineStatGrantedByName('i0d1', "Intelligence", 13.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d2', "Agility", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0d2', "Critical Chance", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0d2', "Intelligence", 13.00)
    call DEqItemTypeDefineStatGrantedByName('i0d2', "Strength", 13.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d3', "Armor", 9.00)
    call DEqItemTypeDefineStatGrantedByName('i0d3', "Health", 95.00)
    call DEqItemTypeDefineStatGrantedByName('i0d3', "Strength", 22.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d4', "Agility", 21.00)
    call DEqItemTypeDefineStatGrantedByName('i0d4', "Health", 106.00)
    call DEqItemTypeDefineStatGrantedByName('i0d4', "Movement Speed", 10.00)
    call DEqItemTypeDefineStatGrantedByName('i0d4', "Strength", 21.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d5', "Strength", 1.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d6', "Agility", 1.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d7', "Intelligence", 1.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d8', "Health", 1.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0d9', "HP Regen %", 10.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e0', "Mana", 500.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e1', "Mana Regen %", 10.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e2', "Critical Chance", 100.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e3', "Damage", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e4', "Melee Damage", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e5', "Melee Damage %", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e6', "Ranged Damage", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e7', "Ranged Damage %", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0e8', "Cleave Pct", 50.00)
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0e9', "Ring")
    call DEqItemTypeDefineStatGrantedByName('i0e9', "Cleave Area", 300.00)
    ...
    // Base: bspd, Class: Ring
    call DEqItemTypeDefineAllowedSlotByName('i0f0', "Ring")
    call DEqItemTypeDefineStatGrantedByName('i0f0', "Attack Speed", 50.00)
    ...
    // Base: bspd, Class: Ring
    call DEqItemTypeDefineAllowedSlotByName('i0f1', "Ring")
    call DEqItemTypeDefineStatGrantedByName('i0f1', "Lifesteal", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f2', "Thorns", 100.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f3', "Thorns %", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f4', "Armor", 25.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f5', "Armor Pct", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f6', "Dodge", 100.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f7', "Magic Damage Taken", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f8', "Melee Damage Taken", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0f9', "Pierce Damage Taken", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g0', "Movement Speed", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g1', "Movement Speed %", 50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g2', "Block Chance", 100.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g3', "Hit Chance", 100.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g4', "Spell Power %", 100.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g5', "Spell Power", 400.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g6', "Magic Damage Taken", -50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g7', "Melee Damage Taken", -50.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i0g8', "Pierce Damage Taken", -50.00)
    ...
    call DEqItemTypeDefineAllowedSlotByName('i1g1', "Ring")
    call DEqItemTypeDefineStatGrantedByName('i1g1', "Agility", 8.00)
    call DEqItemTypeDefineStatGrantedByName('i1g1', "Intelligence", 8.00)
    call DEqItemTypeDefineStatGrantedByName('i1g1', "Strength", 8.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1g6', "Critical Chance", 1.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1g8', "Critical Chance", 1.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1h0', "Critical Chance", 100.00)
    call DEqItemTypeDefineStatGrantedByName('i1h0', "Health", -100.00)
    call DEqItemTypeDefineStatGrantedByName('i1h0', "Hit Chance", 100.00)
    call DEqItemTypeDefineStatGrantedByName('i1h0', "Intelligence", 666.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1h1', "Agility", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i1h1', "Health", 26.00)
    call DEqItemTypeDefineStatGrantedByName('i1h1', "Strength", 5.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1h2', "Critical Chance", 15.00)
    call DEqItemTypeDefineStatGrantedByName('i1h2', "Damage", 39.00)
    call DEqItemTypeDefineStatGrantedByName('i1h2', "Intelligence", 27.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1h3', "Agility", 5.00)
    call DEqItemTypeDefineStatGrantedByName('i1h3', "Health", 29.00)
    call DEqItemTypeDefineStatGrantedByName('i1h3', "Strength", 5.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i1h4', "Armor", 26.00)
    call DEqItemTypeDefineStatGrantedByName('i1h4', "Health", 267.00)
    call DEqItemTypeDefineStatGrantedByName('i1h4', "Movement Speed", 17.00)
    call DEqItemTypeDefineStatGrantedByName('i1h4', "Strength", 62.00)
    ...
    // Base: bspd, Class: MISC
    call DEqItemTypeDefineStatGrantedByName('i68l', "Agility", 14.00)
    call DEqItemTypeDefineStatGrantedByName('i68l', "Health", 70.00)
    call DEqItemTypeDefineStatGrantedByName('i68l', "Strength", 14.00)
    ...
    call DEqItemTypeDefineStatGrantedByName('i68m', "Agility", 14.00)
    call DEqItemTypeDefineStatGrantedByName('i68m', "Health", 150.00)
    call DEqItemTypeDefineStatGrantedByName('i68m', "Strength", 14.00)
    ...
    // |cFFFFFFFFLightning Bolt|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFLightning Strike|r (Common)
    // Base: tdex, Class: Ability
    ...
    // |cFFFFFFFFChain Lightning|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFEarth Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFWater Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFFire Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFWind Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFEarthbind Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFSkyfury Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFWindfury Totem|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFStormstrike|r (Common)
    // Base: tdex, Class: Ability
    ...
    // |cFFFFFFFFHex|r (Common)
    // Base: tdex, Class: Ability

    // Voodoo Spirits (Common)
    // Base: tdex, Class: MISC

    // |cFFFFFFFFVoodoo Curse|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFLightning Shield|r (Common)
    // Base: tdex, Class: Ability
    ...
    // Reset Abilities (Common)
    // Base: tret, Class: MISC

    // Reincarnation (Common)
    // Base: tdex, Class: MISC

    // |cFFFFFFFFStoneskin Totem|r (Common)
    // Base: tdex, Class: Ability

    // Gnoll Pillage (Common)
    // Base: bzbe, Class: MISC
    ...
    // |cFFFFFFFFTotemic Resurgence|r (Common)
    // Base: tdex, Class: Ability

    // |cFFFFFFFFTotemist|r (Common)
    // Base: tdex, Class: Skill

    // Spiritmender (Common)
    // Base: tdex, Class: MISC

    // |cFFFFFFFFStormcaller|r (Common)
    // Base: tdex, Class: Skill
    ...
    // |cFFFFFFFFTotem Master|r (Common)
    // Base: tdex, Class: Ability

    // Spiritual Healing (Common)
    // Base: tdex, Class: MISC

    // |cFFFFFFFFCleansing Totem|r (Common)
    // Base: tdex, Class: Ability
