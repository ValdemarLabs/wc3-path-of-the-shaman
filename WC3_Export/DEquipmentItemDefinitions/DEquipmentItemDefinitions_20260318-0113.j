...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0a8', "Ring1")
    call DEqItemTypeDefineAllowedSlotByName('i0a8', "Ring2")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0b0', "Hands")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0b1', "Chest")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0b4', "Hands")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0c0', "Hands")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0c3', "Hands")
    ...
    call DEqItemTypeDefineAbilityGranted('i0c6', 'AIbx', 1)
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0d3', "Chest")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0e9', "Ring1")
    call DEqItemTypeDefineAllowedSlotByName('i0e9', "Ring2")
    ...
    // Base: bspd, Class: Ring
    call DEqItemTypeDefineAllowedSlotByName('i0f0', "Ring1")
    call DEqItemTypeDefineAllowedSlotByName('i0f0', "Ring2")
    ...
    // Base: bspd, Class: Ring
    call DEqItemTypeDefineAllowedSlotByName('i0f1', "Ring1")
    call DEqItemTypeDefineAllowedSlotByName('i0f1', "Ring2")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0f4', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0f5', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0f6', "Chest")
    call DEqItemTypeDefineStatGrantedByName('i0f6', "Evasion", 100.00)
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0f7', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0f8', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0f9', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0g0', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0g1', "Chest")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0g2', "Off Hand")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0g3', "Hands")
    ...
    call DEqItemTypeDefineAllowedSlotByName('i0g5', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0g6', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0g7', "Chest")
    ...
    // Base: bspd, Class: Hand Armor
    call DEqItemTypeDefineAllowedSlotByName('i0g8', "Chest")
    ...
    // |c0090EE90Copper Chain Shoulders|r (Uncommon)
    // Base: rst1, Class: MISC
    call DEqItemTypeDefineAbilityGranted('i68l', 'AIs4', 1)
    call DEqItemTypeDefineAbilityGranted('i68l', 'AIi4', 1)

    // |c0090EE90Copper Chain Boots|r (Uncommon)
    // Base: rst1, Class: MISC
    call DEqItemTypeDefineAbilityGranted('i68m', 'AIa3', 1)
    call DEqItemTypeDefineAbilityGranted('i68m', 'A669', 1)
