...
function DEqPreDefineItemsHere takes nothing returns nothing
    ...
    // |cffffff00Tel’anor Rod|r (Common)
    ...
    // Earthbind Totem (Common)
    // Base: tdex, Class: MISC

    // Skyfury Totem (Common)
    // Base: tdex, Class: MISC

    // Windfury Totem (Common)
    // Base: tdex, Class: MISC
