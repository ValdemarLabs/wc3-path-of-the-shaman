...
private function Init takes nothing returns nothing
    ...
    call AI_AddProfileProfession(AI_Engineer_ProfileId, AI_PROFESSION_BLACKSMITHING)
    call AI_AddProfileProfession(AI_Engineer_ShredderProfileId, AI_PROFESSION_MINING)
    call AI_AddProfileProfession(AI_Engineer_ShredderProfileId, AI_PROFESSION_BLACKSMITHING)
