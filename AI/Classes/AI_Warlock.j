...
private function RegisterBarks takes integer profileId returns nothing
    call AI_RegisterBarkLine(profileId, AI_BARK_GREET, VL_WARLOCK_HEROWARLOCK_GREET1_TEXT, VL_WARLOCK_HEROWARLOCK_GREET1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_GREET, VL_WARLOCK_HEROWARLOCK_GREET2_TEXT, VL_WARLOCK_HEROWARLOCK_GREET2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_GREET, VL_WARLOCK_HEROWARLOCK_GREET3_TEXT, VL_WARLOCK_HEROWARLOCK_GREET3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_GREET, VL_WARLOCK_HEROWARLOCK_GREET4_TEXT, VL_WARLOCK_HEROWARLOCK_GREET4_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_FAREWELL, VL_WARLOCK_HEROWARLOCK_FAREWELL1_TEXT, VL_WARLOCK_HEROWARLOCK_FAREWELL1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_FAREWELL, VL_WARLOCK_HEROWARLOCK_FAREWELL2_TEXT, VL_WARLOCK_HEROWARLOCK_FAREWELL2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_PASSIVE, VL_WARLOCK_HEROWARLOCK_PASSIVE1_TEXT, VL_WARLOCK_HEROWARLOCK_PASSIVE1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_PASSIVE, VL_WARLOCK_HEROWARLOCK_PASSIVE2_TEXT, VL_WARLOCK_HEROWARLOCK_PASSIVE2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_NORMAL, VL_WARLOCK_HEROWARLOCK_NORMAL1_TEXT, VL_WARLOCK_HEROWARLOCK_NORMAL1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_NORMAL, VL_WARLOCK_HEROWARLOCK_NORMAL2_TEXT, VL_WARLOCK_HEROWARLOCK_NORMAL2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_NORMAL, VL_WARLOCK_HEROWARLOCK_NORMAL3_TEXT, VL_WARLOCK_HEROWARLOCK_NORMAL3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_AGGRESSIVE, VL_WARLOCK_HEROWARLOCK_AGGRESSIVE1_TEXT, VL_WARLOCK_HEROWARLOCK_AGGRESSIVE1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_AGGRESSIVE, VL_WARLOCK_HEROWARLOCK_AGGRESSIVE2_TEXT, VL_WARLOCK_HEROWARLOCK_AGGRESSIVE2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_AGGRESSIVE, VL_WARLOCK_HEROWARLOCK_AGGRESSIVE3_TEXT, VL_WARLOCK_HEROWARLOCK_AGGRESSIVE3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_HOLD, VL_WARLOCK_HEROWARLOCK_HOLDPOSITIONS1_TEXT, VL_WARLOCK_HEROWARLOCK_HOLDPOSITIONS1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_HOLD, VL_WARLOCK_HEROWARLOCK_HOLDPOSITIONS2_TEXT, VL_WARLOCK_HEROWARLOCK_HOLDPOSITIONS2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_DROP_ITEMS, VL_WARLOCK_HEROWARLOCK_DROPITEMS1_TEXT, VL_WARLOCK_HEROWARLOCK_DROPITEMS1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_DROP_ITEMS, VL_WARLOCK_HEROWARLOCK_DROPITEMS2_TEXT, VL_WARLOCK_HEROWARLOCK_DROPITEMS2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_DROP_ITEMS, VL_WARLOCK_HEROWARLOCK_DROPITEMS3_TEXT, VL_WARLOCK_HEROWARLOCK_DROPITEMS3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_IDLE, VL_WARLOCK_HEROWARLOCK_IDLE1_TEXT, VL_WARLOCK_HEROWARLOCK_IDLE1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_IDLE, VL_WARLOCK_HEROWARLOCK_IDLE2_TEXT, VL_WARLOCK_HEROWARLOCK_IDLE2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_MOVING, VL_WARLOCK_HEROWARLOCK_MOVING1_TEXT, VL_WARLOCK_HEROWARLOCK_MOVING1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_MOVING, VL_WARLOCK_HEROWARLOCK_MOVING2_TEXT, VL_WARLOCK_HEROWARLOCK_MOVING2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_MOVING, VL_WARLOCK_HEROWARLOCK_MOVING3_TEXT, VL_WARLOCK_HEROWARLOCK_MOVING3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_CASTING, VL_WARLOCK_HEROWARLOCK_CASTING1_TEXT, VL_WARLOCK_HEROWARLOCK_CASTING1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_CASTING, VL_WARLOCK_HEROWARLOCK_CASTING2_TEXT, VL_WARLOCK_HEROWARLOCK_CASTING2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_CASTING, VL_WARLOCK_HEROWARLOCK_CASTING3_TEXT, VL_WARLOCK_HEROWARLOCK_CASTING3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ATTACKING, VL_WARLOCK_HEROWARLOCK_ATTACKING1_TEXT, VL_WARLOCK_HEROWARLOCK_ATTACKING1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ATTACKING, VL_WARLOCK_HEROWARLOCK_ATTACKING2_TEXT, VL_WARLOCK_HEROWARLOCK_ATTACKING2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ATTACKING, VL_WARLOCK_HEROWARLOCK_ATTACKING3_TEXT, VL_WARLOCK_HEROWARLOCK_ATTACKING3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_KILLING, VL_WARLOCK_HEROWARLOCK_KILLING1_TEXT, VL_WARLOCK_HEROWARLOCK_KILLING1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_KILLING, VL_WARLOCK_HEROWARLOCK_KILLING2_TEXT, VL_WARLOCK_HEROWARLOCK_KILLING2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_KILLING, VL_WARLOCK_HEROWARLOCK_KILLING3_TEXT, VL_WARLOCK_HEROWARLOCK_KILLING3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_KICKED, VL_WARLOCK_HEROWARLOCK_KICKED1_TEXT, VL_WARLOCK_HEROWARLOCK_KICKED1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_COMPANION_DIES, VL_WARLOCK_HEROWARLOCK_OTHERDIES1_TEXT, VL_WARLOCK_HEROWARLOCK_OTHERDIES1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_COMPANION_DIES, VL_WARLOCK_HEROWARLOCK_OTHERDIES2_TEXT, VL_WARLOCK_HEROWARLOCK_OTHERDIES2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_COMPANION_DIES, VL_WARLOCK_HEROWARLOCK_OTHERDIES3_TEXT, VL_WARLOCK_HEROWARLOCK_OTHERDIES3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ITEM_GIVEN, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN1_TEXT, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN1_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ITEM_GIVEN, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN2_TEXT, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN2_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ITEM_GIVEN, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN3_TEXT, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN3_KEY)
    call AI_RegisterBarkLine(profileId, AI_BARK_ITEM_GIVEN, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN4_TEXT, VL_WARLOCK_HEROWARLOCK_ITEMGIVEN4_KEY)
endfunction
