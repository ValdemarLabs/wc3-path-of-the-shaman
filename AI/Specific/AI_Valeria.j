...
private function RegisterBarks takes nothing returns nothing
    ...
    call RegisterNeutralBark(AI_BARK_GREET, "Aradion may listen. I am not so quick.", "Valeria_0183")
    call RegisterFriendlyBark(AI_BARK_GREET, "You came back. That counts for something.", "Valeria_0184")
    call RegisterFriendlyBark(AI_BARK_GREET, "I know your step now. Keep it honest.", "Valeria_0185")
    ...
    call RegisterNeutralBark(AI_BARK_NORMAL, "Eyes open. The Vale hides teeth.", "Valeria_0219")
    ...
    call RegisterCovenantBark(AI_BARK_NORMAL, "Move as one with the trees and they may spare us.", "Valeria_0223")
    ...
    call RegisterCovenantBark(AI_BARK_AGGRESSIVE, "No mercy for those who hunt Elarindor.", "Valeria_0235")
    ...
    call RegisterExaltedBark(AI_BARK_HOLD, "The Vale stands here with me.", "Valeria_0252")
    call RegisterNeutralBark(AI_BARK_KICKED, "Good. I prefer my own company.", "Valeria_0253")
    call RegisterNeutralBark(AI_BARK_KICKED, "Then I go back to Aradion.", "Valeria_0254")
    ...
    call RegisterNeutralBark(AI_BARK_IDLE, "Aradion sees hope where I still see tracks.", "Valeria_0267")
    ...
    call RegisterCovenantBark(AI_BARK_IDLE, "Aradion sees patterns. I see tracks.", "Valeria_0271")
    call RegisterCovenantBark(AI_BARK_IDLE, "The Vale is wounded, but it still answers careful feet.", "Valeria_0272")
    call RegisterCovenantBark(AI_BARK_IDLE, "Aradion blames himself for too much. That does not make him wrong.", "Valeria_0273")
    call RegisterExaltedBark(AI_BARK_IDLE, "For once, the Vale feels almost willing to heal.", "Valeria_0274")
    call RegisterExaltedBark(AI_BARK_IDLE, "I have watched him chase hope through ruins. Now I see why.", "Valeria_0275")
    ...
    call RegisterFriendlyBark(AI_BARK_MOVING, "Keep to the roots; loose stone betrays you.", "Valeria_0281")
    ...
    call RegisterCovenantBark(AI_BARK_MOVING, "Move low. The old shadows still listen.", "Valeria_0284")
    ...
    call RegisterExaltedBark(AI_BARK_MOVING, "We move like friends of this forest now.", "Valeria_0288")
