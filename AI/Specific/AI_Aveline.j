...
private function RegisterCompanionChats takes nothing returns nothing
    ...
    call RegisterChat("Aveline_ChatEngineer3", "Build me something that warns Riverbane before the first spear is thrown.")
    call RegisterChat("Aveline_ChatPaladin1", "Paladin, your Light is welcome on the roads.")
    ...
    call RegisterChat("Aveline_ChatRogue2", "A scout who moves quietly is useful. But your're still a thief.")
    call RegisterChat("Aveline_ChatRogue3", "If you know how bandits think, use it to stop them before they choose a victim.")
    call RegisterChat("Aveline_ChatShaman1", "Shaman, if the spirits know why raiders keep crossing our river, I would love to hear it.")
    call RegisterChat("Aveline_ChatShaman2", "Tell the wind to carry warning before it carries smoke.")
    call RegisterChat("Aveline_ChatShaman3", "Your healing is welcome, but I would rather prevent the wounds in the first place.")
    ...
    call RegisterChat("Aveline_ChatUndeadWarlock2", "It is disturbing to have a walking corpse among us.")
    ...
    call RegisterChat("Aveline_ChatWarrior3", "A strong charge breaks enemies and a steady shield saves families.")
endfunction
...
private function RegisterRogueReplies takes nothing returns nothing
    ...
    call RegisterReply("HeroRogue_ChatGeneral5", "Well you are quite shady!")
    ...
    call RegisterReply("HeroRogue_ChatWarrior2", "Doorways matter less than who stands in them when the raiders come.")
    ...
    call RegisterReply("HeroRogue_ChatEngineer2", "Fix the cloak after you fix these damn roads.")
    call RegisterReply("HeroRogue_ChatEngineer3", "Yes, a quiet turret would be a blessing on patrol.")
    call RegisterReply("HeroRogue_ChatEngineer4", "At least warn us before testing the more bigger bombs.")
    call RegisterReply("HeroRogue_ChatPaladin1", "Armor polish matters less than who steps between danger and a child.")
    call RegisterReply("HeroRogue_ChatPaladin2", "The Light can blind... But so can greed.")
...
private function RegisterWarlockReplies takes nothing returns nothing
    ...
    call RegisterReply("HeroWarlock_ChatRogue2", "Remind me why do we have these two on our party?")
    call RegisterReply("HeroWarlock_ChatRogue3", "Plotting has its uses. Betrayal does not.")
    call RegisterReply("HeroWarlock_ChatRogue4", "Keep your dirty secrets to yourself.")
    ...
    call RegisterReply("HeroWarlock_ChatWarrior3", "A tauren does not need to sneak when the road needs a wall.")
    ...
    call RegisterReply("HeroWarlock_ChatShaman4", "This dark spell that you repeatedly cast on yourself can be healed only so much.")
    call RegisterReply("HeroWarlock_ChatEngineer1", "If you truly are engineer, you would know to verify and validate such things!")
    call RegisterReply("HeroWarlock_ChatEngineer2", "Don't play his dirty games...")
    call RegisterReply("HeroWarlock_ChatEngineer3", "I don't think this engineer needs to compensate anything. Different story on your end though.")
    call RegisterReply("HeroWarlock_ChatEngineer4", "I don't think that's a good idea...")
    ...
    call RegisterReply("HeroWarlock_ChatPaladin3", "It's clear you two don't get along, but can you just try at least for a minute?")
    call RegisterReply("HeroWarlock_ChatPaladin4", "Preaching has its place in this cruel world.")
    call RegisterReply("HeroWarlock_ChatPaladin5", "This conversation was bored before you even started it.")
