...
private function RegisterBarks takes nothing returns nothing
    call RegisterNeutralBark(AI_BARK_GREET, "Once a magister, now a man asking caution from strangers.", "Aradion_0181")
    call RegisterNeutralBark(AI_BARK_GREET, "Welcome, traveler. Please forgive the tension in this place.", "Aradion_0182")
    call RegisterNeutralBark(AI_BARK_GREET, "Come gently. Elarindor startles easily.", "Aradion_0183")
    call RegisterFriendlyBark(AI_BARK_GREET, "It is good to see a familiar face in Elarindor.", "Aradion_0184")
    call RegisterFriendlyBark(AI_BARK_GREET, "Ah, you return. That is no small comfort.", "Aradion_0185")
    call RegisterFriendlyBark(AI_BARK_GREET, "You are not unwelcome here.", "Aradion_0186")
    ...
    call RegisterCovenantBark(AI_BARK_GREET, "Valeria trusts you more than she admits.", "Aradion_0189")
    call RegisterExaltedBark(AI_BARK_GREET, "My friend, Elarindor still stands because you refused to abandon it.", "Aradion_0190")
    call RegisterExaltedBark(AI_BARK_GREET, "You bring hope with you. I had almost forgotten the sound.", "Aradion_0191")
    call RegisterExaltedBark(AI_BARK_GREET, "Come, dear friend. The Vale feels lighter when you are near.", "Aradion_0192")
    call RegisterNeutralBark(AI_BARK_FAREWELL, "Go carefully. I would not lose another possible ally.", "Aradion_0193")
    call RegisterNeutralBark(AI_BARK_FAREWELL, "May your path avoid the hungrier shadows.", "Aradion_0194")
    call RegisterNeutralBark(AI_BARK_FAREWELL, "Leave with caution. The ruins remember strangers.", "Aradion_0195")
    ...
    call RegisterExaltedBark(AI_BARK_FAREWELL, "Farewell, my friend. Come back to us.", "Aradion_0204")
    ...
    call RegisterNeutralBark(AI_BARK_NORMAL, "I will follow, but I will question danger.", "Aradion_0219")
    ...
    call RegisterCovenantBark(AI_BARK_NORMAL, "Together, perhaps we can make these ruins teach instead of mourn.", "Aradion_0223")
    ...
    call RegisterNeutralBark(AI_BARK_AGGRESSIVE, "If battle is forced on us, let it be brief.", "Aradion_0229")
    call RegisterNeutralBark(AI_BARK_AGGRESSIVE, "I will help, though I wish we had more time.", "Aradion_0230")
    call RegisterNeutralBark(AI_BARK_AGGRESSIVE, "Very well. I remember enough magic for this.", "Aradion_0231")
    ...
    call RegisterExaltedBark(AI_BARK_AGGRESSIVE, "For every soul this ruin tried to claim.", "Aradion_0240")
    ...
    call RegisterNeutralBark(AI_BARK_KICKED, "Then I return to my studies, and to Valeria.", "Aradion_0253")
    ...
    call RegisterCovenantBark(AI_BARK_KICKED, "Go on. I will keep the research alive.", "Aradion_0259")
    call RegisterCovenantBark(AI_BARK_KICKED, "You know where to find us.", "Aradion_0260")
    call RegisterCovenantBark(AI_BARK_KICKED, "I will be ready when Elarindor needs us again.", "Aradion_0261")
    ...
    call RegisterExaltedBark(AI_BARK_KICKED, "Send word, and I will come as quickly as these old bones allow.", "Aradion_0264")
    call RegisterNeutralBark(AI_BARK_IDLE, "A failed magister can still read the shape of a disaster.", "Aradion_0265")
    call RegisterNeutralBark(AI_BARK_IDLE, "The arcane still hums beneath the stones, wounded but not silent.", "Aradion_0266")
    ...
    call RegisterNeutralBark(AI_BARK_MOVING, "Step where the stones are quiet.", "Aradion_0279")
    ...
    call RegisterExaltedBark(AI_BARK_MOVING, "Valeria says I should smile more. Despite the circumstances... she may be right.", "Aradion_0286")
    ...
    call RegisterCommonBark(AI_BARK_ATTACKING, "I remember enough magic for this.", "Aradion_0298")
    call RegisterCommonBark(AI_BARK_ATTACKING, "Old power, new purpose.", "Aradion_0299")
    call RegisterCommonBark(AI_BARK_ATTACKING, "No more stolen futures.", "Aradion_0300")
