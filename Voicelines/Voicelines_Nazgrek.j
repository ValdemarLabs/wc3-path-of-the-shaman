    ...
    **/
    ...
    globals
        ...
        constant string VL_NAZGREK_GENERIC_0029_KEY = "NazgrekGeneric_0029"
        constant string VL_NAZGREK_GENERIC_0029_TEXT = "You are safe. The road is behind us."
        constant string VL_NAZGREK_GENERIC_0030_KEY = "NazgrekGeneric_0030"
        constant string VL_NAZGREK_GENERIC_0030_TEXT = "We reached shelter. Your journey is finished."
        constant string VL_NAZGREK_GENERIC_0031_KEY = "NazgrekGeneric_0031"
    ...
    private function RegisterGenericQuestLines takes nothing returns nothing
        ...
        call QuestsGeneric_RegisterHeroVoiceVariant(QuestsGeneric_HERO_LINE_COMPLETE_ESCORT, VL_NAZGREK_GENERIC_TYPE, VL_NAZGREK_GENERIC_0029_TEXT, 29)
        call QuestsGeneric_RegisterHeroVoiceVariant(QuestsGeneric_HERO_LINE_COMPLETE_ESCORT, VL_NAZGREK_GENERIC_TYPE, VL_NAZGREK_GENERIC_0030_TEXT, 30)
        call QuestsGeneric_RegisterHeroVoiceVariant(QuestsGeneric_HERO_LINE_COMPLETE_ESCORT, VL_NAZGREK_GENERIC_TYPE, VL_NAZGREK_GENERIC_0031_TEXT, 31)
        call QuestsGeneric_RegisterHeroVoiceVariant(QuestsGeneric_HERO_LINE_COMPLETE_ESCORT, VL_NAZGREK_GENERIC_TYPE, VL_NAZGREK_GENERIC_0032_TEXT, 32)
    endfunction
