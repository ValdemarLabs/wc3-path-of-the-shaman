...
The elemental chain now uses Elemental Master `o627`, Summon Elemental `A67Q`, and essences Air `I6C7`, Earth `I6C8`, Fire `I6C5`, and Water `I6C6`. Stormcaller `A6A3` remains required. Elemental essences are excluded from generic unit loot, gathering, and vendor stock; matching hostile elemental types provide them through specific drops, and player-summoned elementals are excluded. Ability rewards, rawcodes, and actual trainer ownership for the remaining class quests still require separate design against the current ability system.
