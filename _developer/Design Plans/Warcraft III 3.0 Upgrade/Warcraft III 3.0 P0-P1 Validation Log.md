...
World Editor owns placed-doodad pitch, roll, local-axis scale, team color, and
pathing verification. Make these changes only in the disposable full-map copy.
