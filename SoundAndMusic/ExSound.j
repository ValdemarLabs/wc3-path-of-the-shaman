...
private function Init takes nothing returns nothing
    ...
    call ExSound_Register("Zulkis_ItemErrorAny", "Pots\\Sound\\Voicelines\\Zulkis\\ZulkisEventLines\\Zulkis_ItemErrorAny.mp3")
    call ExSound_Register("Zulkis_ItemErrorGeneral", "Pots\\Sound\\Voicelines\\Zulkis\\ZulkisEventLines\\Zulkis_ItemErrorGeneral.mp3")
    call ExSound_Register("Zulkis_ItemErrorGeneral2", "Pots\\Sound\\Voicelines\\Zulkis\\ZulkisEventLines\\Zulkis_ItemErrorGeneral2.mp3")
    ...
    call ExSound_RegisterZulkisEventSequence("Zulkis_GreetTrainer", 1, 4)
    call ExSound_RegisterZulkisEventSequence("Zulkis_FarewellTrainer", 1, 3)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Info", 1, 4)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Trade", 1, 1)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Exit", 1, 1)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Follow", 1, 1)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Stop", 1, 1)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Decline", 1, 1)
    call ExSound_RegisterZulkisEventSequence("Zulkis_Accept", 1, 1)
