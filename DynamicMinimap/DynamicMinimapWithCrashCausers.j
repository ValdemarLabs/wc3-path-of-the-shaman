...
private function UpdateMinimapAndBounds takes integer chunkCoordX, integer chunkCoordY returns nothing
    ...
    // local real mapMinX = GetRectMinX(bj_mapInitialPlayableArea) - this could cause crash on huge maps
    // local real mapMinY = GetRectMinY(bj_mapInitialPlayableArea) - this could cause crash on huge maps
    local real mapMinX = -30720.0  // 480 tiles * 128 units / 2
    local real mapMinY = -30720.0  // Hardcoded to prevent crashes
...
private function Init takes nothing returns nothing
    ...
    set originalCameraBounds = Rect(MAP_MIN_X, MAP_MIN_Y, MAP_MAX_X, MAP_MAX_Y)
