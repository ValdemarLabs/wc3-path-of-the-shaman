...
namespace WC3ItemManager
{
    internal static class CookingItemsSeeder
    {
        ...
        {
            Food("j0c6", "Smoked Wolf Jerky", "Uncommon", 10, 65, "+1 Agility, +1 hit point regeneration."),
            Food("j0c7", "Roasted Stag Haunch", "Uncommon", 10, 70, "+1 Strength, +50 maximum hit points."),
            Food("j0c8", "Bear Fat Biscuit", "Uncommon", 12, 85, "+2 Strength, +100 maximum hit points, +1 hit point regeneration."),
            Food("j0c9", "Boiled Makrura Claw", "Uncommon", 12, 90, "+2 Intelligence, +60 maximum mana, +1 mana regeneration."),
            Food("j0d0", "Spiced Snake Strips", "Uncommon", 12, 75, "+2 Agility, +1 Critical Chance."),
            Food("j0d1", "Fried Crawler Cake", "Uncommon", 12, 95, "+1 Armor, +1 Block, +1 hit point regeneration."),

            FishFood("j2b0", "Brilliant Smallfish", "Common", 1, 18, "+1 hit point regeneration, +25 maximum hit points."),
            FishFood("j2b1", "Slitherskin Mackerel", "Common", 15, 22, "+35 maximum mana, +1 mana regeneration."),
            Food("j2a0", "Charred Boar Ribs", "Common", 75, 90, "+3 Strength, +3 Damage."),
            FishFood("j2b2", "Mud Snapper Cake", "Common", 50, 60, "+75 maximum hit points, +1 Dodge."),
            Stew("j2a1", "Rabbit Broth", "Common", 80, 85, "+2 hit point regeneration, +1 Dodge, +40 maximum mana."),
            Food("j2a2", "Hawk Skewer", "Uncommon", 90, 105, "+3 Agility, +1 Hit, +4 Damage."),
            FishFood("j2b3", "Rainbow Albacore", "Uncommon", 95, 110, "+2 Agility, +2 Hit, +1 mana regeneration."),
            Stew("j2a3", "Turtle Stew", "Uncommon", 100, 125, "+2 Armor, +2 Block, +150 maximum hit points."),
            Stew("j2b4", "Catfish Chowder", "Uncommon", 110, 135, "+125 maximum hit points, +2 hit point regeneration, +1 Armor."),
            Stew("j2a4", "Murloc Fin Soup", "Uncommon", 120, 145, "+3 Intelligence, +90 maximum mana, +1 Spell Power."),
            FishFood("j2b5", "Loch Frenzy Delight", "Uncommon", 125, 145, "+2 Critical Chance, +2 Hit, +4 Damage."),
            Food("j2a5", "Lizard Pepper Roast", "Uncommon", 130, 150, "+3 Strength, +5 Damage, +1 Critical Chance."),
            Stew("j2b6", "Firefin Chili", "Uncommon", 140, 175, "+5 Spell Power, +2 Critical Chance, -1 Armor."),
            Food("j2a6", "Tiger Steak", "Uncommon", 150, 190, "+5 Agility, +2 Critical Chance, +7 Damage."),
            Stew("j2b7", "Sagefish Soup", "Uncommon", 155, 200, "+4 Intelligence, +2 mana regeneration, +5 Spell Power."),
            Food("j2a7", "Panther Fillet", "Uncommon", 165, 215, "+5 Agility, +2 Dodge, +12 movement speed."),
            FishFood("j2b9", "Rockscale Cod", "Uncommon", 170, 225, "+3 Armor, +2 Block, +100 maximum hit points."),
            Stew("j2a8", "Raptor Chili", "Rare", 180, 260, "+5 Strength, +8 Damage, +3 Critical Chance, -1 Hit."),
            FishFood("j2c0", "Mithril Head Trout", "Uncommon", 190, 250, "+3 Block, +2 Armor, +3 Hit."),
            Food("j2a9", "Cow Rump Roast", "Uncommon", 200, 280, "+4 Strength, +250 maximum hit points, +2 hit point regeneration."),
            FishFood("j2c1", "Spotted Yellowtail", "Uncommon", 205, 275, "+4 Agility, +3 Hit, +10 movement speed."),
            OddFood("j2d2", "Deviate Delight", "Rare", 215, 330, "+4 Agility, +3 Dodge, -2 Intelligence, +30 sight range."),
            FishFood("j2c2", "Glossy Mightfish Steak", "Rare", 225, 390, "+7 Strength, +12 Damage, +4 Critical Chance."),
            FishFood("j2c3", "Redgill Skillet", "Rare", 230, 405, "+4 Critical Chance, +5 Hit, +6 Damage."),
            Stew("j2c4", "Nightfin Soup", "Rare", 240, 440, "+3 mana regeneration, +10 Spell Power, +180 maximum mana."),
            FishFood("j2c5", "Sunscale Fillet", "Rare", 245, 450, "+4 hit point regeneration, +300 maximum hit points, +2 Armor."),
            FishFood("j2c6", "Stonescale Eel", "Rare", 250, 475, "+4 Armor, +5 Block, -8 movement speed."),
            FishFood("j2c7", "Whitescale Salmon", "Rare", 260, 520, "+5% Spell Power, +250 maximum mana, +4 Hit."),
            Stew("j2c8", "Darkclaw Bisque", "Rare", 270, 600, "+8 Strength, +300 maximum hit points, +4 Armor."),
            FishFood("j2c9", "Winter Squid", "Rare", 280, 650, "+8 Agility, +5 Critical Chance, +6 Dodge."),
            FishFood("j2d0", "Summer Bass", "Rare", 290, 675, "+20 movement speed, +5 Hit, +5 Dodge."),
            OddFood("j2d1", "Tigerseye Eel", "Rare", 300, 720, "+25 Spell Power, +5 Dodge, +5% Spell Power."),
            OddFood("j2d3", "Ember Whelp Roast", "Rare", 285, 700, "+20 Damage, +5% Spell Power, +5 Critical Chance, -2 Armor."),
            OddFood("j2d4", "Plaguebloom Dumpling", "Rare", 295, 730, "+8 Critical Chance, +8 Spell Power, +40 sight range, -2 hit point regeneration."),

            Beverage("j3a0", "Springwater Tea", "Common", 1, 25, "+25 maximum mana, +1 mana regeneration."),
            Beverage("j3a1", "Honeyed Milk", "Common", 20, 35, "+50 maximum hit points, -1 Intelligence."),
            Beverage("j3a2", "Bitter Cactus Ale", "Common", 45, 55, "+1 Strength, -2 Intelligence, -1 Armor."),
            Beverage("j3a3", "Stout Mead", "Uncommon", 75, 95, "+3 Strength, -2 Intelligence, -1 Armor."),
            Beverage("j3a4", "Salted Makrura Broth", "Uncommon", 90, 110, "+1 mana regeneration, +60 maximum mana, -1 Armor."),
            Beverage("j3a5", "Blackmouth Grog", "Uncommon", 120, 150, "+5 Damage, -2 Hit, -3 Intelligence."),
            Beverage("j3a6", "Firefin Whiskey", "Uncommon", 150, 210, "+3 Critical Chance, +6 Damage, -4 Intelligence, -2 Armor."),
            Beverage("j3a7", "Sagefish Tonic", "Uncommon", 175, 230, "+4 Intelligence, +1 mana regeneration, -1 Armor."),
            Beverage("j3a8", "Deviate Rum", "Rare", 200, 310, "+5 Dodge, -5 Hit, +20 sight range, -4 Intelligence."),
            Beverage("j3a9", "Nightfin Wine", "Rare", 225, 380, "+15 Spell Power, -20 movement speed, -2 Armor."),
            Beverage("j3b0", "Stonescale Porter", "Rare", 250, 430, "+4 Armor, +4 Block, -4 Agility."),
            Beverage("j3b1", "Lobster Bisque Cup", "Rare", 270, 500, "+200 maximum hit points, +2 hit point regeneration, -3 Intelligence."),
            Beverage("j3b2", "Dragonfire Punch", "Rare", 285, 620, "+20 Damage, +5 Critical Chance, -5 Intelligence, -4 Armor."),
            Beverage("j3b3", "Winter Squid Absinthe", "Rare", 295, 680, "+10% Spell Power, +10 Spell Power, -5 Hit, -6 Intelligence."),
            Beverage("j3b4", "Brew of Bad Ideas", "Rare", 300, 750, "+10 Critical Chance, +10 Damage, -10 Intelligence, -5 Dodge, -5 Armor."),
        ...
        private static void UpsertItem(NpgsqlConnection conn, SeedItem item)
        {
            ...
            using (var cmd = new NpgsqlCommand(query, conn))
            {
                ...
                cmd.Parameters.AddWithValue("item_level", item.Level);
