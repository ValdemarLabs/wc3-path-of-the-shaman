library DConfigurationArea initializer Init requires Table
...
boolean AutomaticallyAddHeroesToTheSystem = TRUE
...
boolean MakeDInventoryDropDroppedOnDeathItems = FALSE
...
boolean InfiniteStackingSystemAllowed = TRUE
...
boolean AutomaticallyAddHeroesToTheDEqSystem = TRUE
