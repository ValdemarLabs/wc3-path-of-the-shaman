...
// =======================================================================
// ====== Path of the Shaman items
// Infernal Sigil of Colossus
call DEqItemTypeDefineAllowedSlotByName('I6CF', "Neck")
call DEqItemTypeDefineStatGrantedByName('I6CF', "Intelligence", 15)
call DEqItemTypeDefineStatGrantedByName('I6CF', "Mana", 200)
call DEqItemTypeDefineStatGrantedByName('I6CF', "Hitpoints", 200)
// add block as test
call DEqItemTypeDefineStatGrantedByName('I6CF', "Block Chance", 100) 
call DEqItemTypeDefineStatGrantedByName('I6CF', "Spell Power",250)
call DEqItemTypeDefineGoldValue('I6CF', 30000)

// Blazing Obsidian Sharpblade 
call DEqItemTypeDefineAllowedSlotId('I6CB', 19)
call DEqItemTypeDefineAs2Handed('I6CB')
call DEqItemTypeDefineStatGrantedByName('I6CB', "Melee Damage", 35)
call DEqItemTypeDefineStatGrantedByName('I6CB', "Strength", 15)
call DEqItemTypeDefineStatGrantedByName('I6CB', "Critical Chance", 100)
call DEqItemTypeDefineAbilityGranted('I6CB', 'A65E', 1)
//set goldCost = GetItemTypeIdGoldCost('I6CB')
//call DEqItemTypeDefineGoldValue('I6CB', goldCost)
