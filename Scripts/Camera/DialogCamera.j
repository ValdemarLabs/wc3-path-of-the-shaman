...
/*
    ...
    Params for DialogCameraStart:
      ...
      blockRadius   - Radius to check for blocking destructibles (default 350 if <= 0)
      doBlockCheck  - If true, checks for blocking destructibles and flips camera if blocked
