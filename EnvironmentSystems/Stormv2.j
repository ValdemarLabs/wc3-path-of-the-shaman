library Storm initializer Init requires DNC, ZoneEvent
    ...
    */
    ...
    globals
        ...
        //
        public  boolean TF          = false              // Whether fog is used        
    ...
    private function Init takes nothing returns nothing
        ...
        //==========================================
    private function TF_SetFog takes nothing returns nothing
    // set fog parameters based on current zone weather
        local integer zoneId = ZonesCore_GetCurrentZone()
        local ZoneData z = ZonesCore_GetZoneData(zoneId)
        local string weather
        if z != 0 then
            set weather = z.GetWeatherState()
            if weather == "none" then
                set TF_zstart = z.fogDay[0]
                set TF_zend   = z.fogDay[1]
                set TF_red    = z.fogDay[2]
                set TF_green  = z.fogDay[3]
                set TF_blue   = z.fogDay[4]
            elseif weather == "rain_light" then
                set TF_zstart = z.fogWeatherLight[0]
                set TF_zend   = z.fogWeatherLight[1]
                set TF_red    = z.fogWeatherLight[2]
                set TF_green  = z.fogWeatherLight[3]
                set TF_blue   = z.fogWeatherLight[4]
            elseif weather == "rain_medium" then
                set TF_zstart = z.fogWeatherMedium[0]
                set TF_zend   = z.fogWeatherMedium[1]
                set TF_red    = z.fogWeatherMedium[2]
                set TF_green  = z.fogWeatherMedium[3]
                set TF_blue   = z.fogWeatherMedium[4]
            elseif weather == "rain_heavy" or weather == "storm" then
                set TF_zstart = z.fogWeatherHeavy[0]
                set TF_zend   = z.fogWeatherHeavy[1]
                set TF_red    = z.fogWeatherHeavy[2]
                set TF_green  = z.fogWeatherHeavy[3]
                set TF_blue   = z.fogWeatherHeavy[4]
            elseif weather == "snow_light" then
                ...
                set TF_green  = z.fogWeatherLight[3]
                set TF_blue   = z.fogWeatherLight[4]
            elseif weather == "snow_medium" then
                set TF_zstart = z.fogWeatherMedium[0]
                set TF_zend   = z.fogWeatherMedium[1]
                set TF_red    = z.fogWeatherMedium[2]
                set TF_green  = z.fogWeatherMedium[3]
                set TF_blue   = z.fogWeatherMedium[4]
            elseif weather == "snow_heavy" then
                set TF_zstart = z.fogWeatherHeavy[0]
                set TF_zend   = z.fogWeatherHeavy[1]
                set TF_red    = z.fogWeatherHeavy[2]
                set TF_green  = z.fogWeatherHeavy[3]
