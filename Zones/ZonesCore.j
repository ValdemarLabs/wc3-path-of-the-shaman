...
private function ConfigureZones takes nothing returns nothing
    ...
    set z.fogWeatherLight[4] = 5.0
    set z.fogWeatherMedium[0] = 1000.0  
    set z.fogWeatherMedium[1] = 8000.0
    set z.fogWeatherMedium[2] = 85.0
    set z.fogWeatherMedium[3] = 5.0
    set z.fogWeatherMedium[4] = 5.0
    set z.fogWeatherHeavy[0] = 1000.0  
    set z.fogWeatherHeavy[1] = 8000.0
    set z.fogWeatherHeavy[2] = 85.0
    set z.fogWeatherHeavy[3] = 5.0
    set z.fogWeatherHeavy[4] = 5.0
    set z.ambientDaySound = ""
    set z.ambientNightSound = ""
    set z.ambientRegion = ""
