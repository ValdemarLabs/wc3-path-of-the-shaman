Quest Crystals Hope Complete
    ...
    Actions
        ...
        Custom script:   call ConditionalTriggerExecute(gg_trg_Quest_Crystals_Hope_Create)
        -------- Update the quest --------
        Quest - Mark QuestCrystalsHope as Discovered
        Quest - Mark QuestCrystalsHopeReq1 as Completed
        Quest - Mark QuestCrystalsHopeReq2 as Completed
        Quest - Mark QuestCrystalsHope as Completed
