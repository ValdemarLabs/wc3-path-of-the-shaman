Quest Rifts Corruption Complete
    Events
    Conditions
    Actions
        -------- ======= ================================= ========================== --------
        ...
        Custom script:   call ConditionalTriggerExecute(gg_trg_Quest_Rifts_Corruption_Create)
        -------- Update the quest --------
        ...
        Quest - Mark QuestRiftsCorruptionReq3 as Completed
        Quest - Mark QuestRiftsCorruptionReq4 as Completed
        Quest - Mark QuestRiftsCorruption as Completed
