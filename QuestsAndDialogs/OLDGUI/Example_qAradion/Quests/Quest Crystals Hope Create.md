Quest Crystals Hope Create
    ...
    Actions
        ...
        Set VariableSet QuestTitleTemp = (Crystals of Hope + <Empty String>)
        Set VariableSet QuestIconPathTemp = ReplaceableTextures\CommandButtons\BTNINV_Misc_Gem_Crystal_01.blp
        Set VariableSet QuestDescriptionTemp = (Aradion wants to study the mana crystals that can be found anywhere in Vanguard Vale. + |n|n)
        ...
        Set VariableSet QuestRequirement1Temp = (Find 6 Mana Crystals + <Empty String>)
        ...
        Set VariableSet QuestCrystalsHope = (Last created quest)
        Quest - Create a quest requirement for QuestCrystalsHope with the description QuestRequirement1[QuestID]
        Set VariableSet QuestCrystalsHopeReq1 = (Last created quest requirement)
        -------- ======= ========================== --------
