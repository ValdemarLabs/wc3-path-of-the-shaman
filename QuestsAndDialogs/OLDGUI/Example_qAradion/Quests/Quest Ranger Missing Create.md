Quest Ranger Missing Create
    ...
    Actions
        ...
        Set VariableSet QuestTitleTemp = (Ranger Missing + <Empty String>)
        Set VariableSet QuestIconPathTemp = ReplaceableTextures\CommandButtons\BTNHighElvenArcher.blp
        Set VariableSet QuestDescriptionTemp = (Find Valeria somewhere in Vanguard Vale or Verdant Plains. + |n|n)
        ...
        Set VariableSet QuestRequirement1Temp = (Find Valeria + <Empty String>)
        ...
        Set VariableSet QuestRangerMissing = (Last created quest)
        Quest - Create a quest requirement for QuestRangerMissing with the description QuestRequirement1[QuestID]
        Set VariableSet QuestRangerMissingReq1 = (Last created quest requirement)
        -------- ======= ========================== --------
