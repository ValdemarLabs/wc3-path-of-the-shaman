...
library qGarrickHolt initializer Init requires QuestsVendor, VoicelinesQuests
    private function Init takes nothing returns nothing
        ...
        call QuestsVendor_RegisterFetchQuest('n035', "Riverbane Iron", "daily", 5, "Riverbane Iron", "ReplaceableTextures\\CommandButtons\\BTNHumanMeleeUpOne.blp", "Bring Garrick enough iron ore to replace the day's damaged weapons.", 'I67E', 6, 30, VL_GENERIC_HUMAN_MALE_1_TYPE, 1001, VL_VENDORQUEST_HUMAN_0001, VL_VENDORQUEST_HUMAN_0002)
        set definitionId = QuestsVendor_RegisterFetchQuest('n035', "Riverbane's Reserve", "normal", 10, "Riverbane's Reserve", "ReplaceableTextures\\CommandButtons\\BTNHumanMeleeUpOne.blp", "Build Riverbane's emergency reserve with ten pieces of dense ore.", 'I67H', 10, 75, VL_GENERIC_HUMAN_MALE_1_TYPE, 1019, VL_VENDORQUEST_HUMAN_0019, VL_VENDORQUEST_HUMAN_0020)
