...
library qMaerithSilvercrest initializer Init requires QuestsVendor, VoicelinesQuests
    private function Init takes nothing returns nothing
        ...
        set normalDefinitionId = QuestsVendor_RegisterKillQuest('h00S', "The Quartermaster's Oath", "normal", 18, "The Quartermaster's Oath", "ReplaceableTextures\\CommandButtons\\BTNGhost.blp", "Destroy ten mana wraiths stalking the paths between Elarindor's supply wards.", 'n002', 10, 110, VL_VENDORQUEST_ELARINDOR_TYPE, 13, VL_VENDORQUEST_ELARINDOR_0013, VL_VENDORQUEST_ELARINDOR_0014)
