...
library qRixitRoadcoin initializer Init requires QuestsVendor, VoicelinesQuests
    private function Init takes nothing returns nothing
        ...
        set normalDefinitionId = QuestsVendor_RegisterKillQuest('n03X', "A Cart Worth Guarding", "normal", 10, "A Cart Worth Guarding", "ReplaceableTextures\\CommandButtons\\BTNSatyrTrickster.blp", "Remove the shadowdancers preying on Rixit's most profitable cart route.", 'nsty', 12, 75, VL_VENDORQUEST_GOBLIN_TYPE, 17, VL_VENDORQUEST_GOBLIN_0017, VL_VENDORQUEST_GOBLIN_0018)
        call QuestsVendor_SetExtendedDialogue(normalDefinitionId, VL_VENDORQUEST_GOBLIN_0019, 19, VL_VENDORQUEST_GOBLIN_0020, 20)
    endfunction
endlibrary
