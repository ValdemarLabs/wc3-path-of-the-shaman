...
library qAerendirSunblade initializer Init requires VendorQuests, VoicelinesVendorQuests
    private function Init takes nothing returns nothing
        local integer definitionId = VendorQuests_RegisterKillQuest('n04O', "Wraiths at the Forge", "daily", 16, "Wraiths at the Forge", "ReplaceableTextures\\CommandButtons\\BTNGhost.blp", "Destroy the mana wraiths drifting toward Aerendir's restored forge.", 'n002', 6, 80, VL_VENDORQUEST_ELARINDOR_TYPE, 1, VL_VENDORQUEST_ELARINDOR_0001, VL_VENDORQUEST_ELARINDOR_0002)
