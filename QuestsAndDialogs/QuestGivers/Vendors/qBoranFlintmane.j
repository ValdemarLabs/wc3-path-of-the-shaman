...
**/
library qBoranFlintmane initializer Init requires QuestsVendor, VoicelinesQuests, qANightToRemember
    private function Init takes nothing returns nothing
        ...
        call qANightToRemember_RegisterVendorType('o01B', VL_GENERIC_TAUREN_MALE_1_TYPE, 1101)
