...
**/
library qMordrakCindercoin initializer Init requires QuestsVendor, VoicelinesQuests, qANightToRemember
    private function Init takes nothing returns nothing
        call qANightToRemember_RegisterVendorType('o00T', VL_GENERIC_ORC_MALE_1_TYPE, 1101)
