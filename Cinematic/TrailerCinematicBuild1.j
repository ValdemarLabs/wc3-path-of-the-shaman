...
function InitCamerasTrailer2 takes nothing returns nothing
    // Assign all camera pairs 
    // For newer areas showcase
    set camA[1]  = gg_cam_cam101a
    set camB[1]  = gg_cam_cam101b
    set camA[2]  = gg_cam_cam102a   
    set camB[2]  = gg_cam_cam102b
    set camA[3]  = gg_cam_cam103a
    set camB[3]  = gg_cam_cam103b
    set camA[4]  = gg_cam_cam104a
    set camB[4]  = gg_cam_cam104b
    set camA[5]  = gg_cam_cam105a
    set camB[5]  = gg_cam_cam105b
    set camA[6]  = gg_cam_cam106a
    set camB[6]  = gg_cam_cam106b
    set camA[7]  = gg_cam_cam107a
    set camB[7]  = gg_cam_cam107b
    set camA[8]  = gg_cam_cam108a
    set camB[8]  = gg_cam_cam108b
    set camA[9]  = gg_cam_cam109a
    set camB[9]  = gg_cam_cam109b
    set camA[10] = gg_cam_cam110a
    set camB[10] = gg_cam_cam110b
    set camA[11] = gg_cam_cam111a
    set camB[11] = gg_cam_cam111b
    set camA[12] = gg_cam_cam112a
    set camB[12] = gg_cam_cam112b
    set camA[13] = gg_cam_cam113a
    set camB[13] = gg_cam_cam113b
    set camA[14] = gg_cam_cam114a
    set camB[14] = gg_cam_cam114b
    set camA[15] = gg_cam_cam115a
    set camB[15] = gg_cam_cam115b
    set camA[16] = gg_cam_cam116a
    set camB[16] = gg_cam_cam116b
    set camA[17] = gg_cam_cam117a
    set camB[17] = gg_cam_cam117b
    set camA[18] = gg_cam_cam118a
    set camB[18] = gg_cam_cam118b
    set camA[19] = gg_cam_cam119a
    set camB[19] = gg_cam_cam119b
    set camA[20] = gg_cam_cam120a
    set camB[20] = gg_cam_cam120b
    set camA[21] = gg_cam_cam121a
    set camB[21] = gg_cam_cam121b
    set camA[22] = gg_cam_cam122a
    set camB[22] = gg_cam_cam122b
    set camA[23] = gg_cam_cam123a   
    set camB[23] = gg_cam_cam123b
...
function PlayNextCameraPan takes nothing returns nothing
    ...
    // Exit condition
    if cinematicIndex > cinematicIndexEnd then
    ...
    // Set FoV to 120 - This can be too much or want to have camera specific FoV -> then comment this out
    call SetCameraFieldForPlayer( Player(0), CAMERA_FIELD_FIELD_OF_VIEW, 120.00, 0 )
...
function PlayCinematicTrailer1 takes nothing returns nothing
    ...
    call TimerStart(msgClearTimer, 0.05, true, function ClearMessagesPeriodic)
...
function PlayCinematicTrailer2 takes nothing returns nothing
    ...
    // Initialize cinematic index
    set cinematicIndex = 1
    set cinematicIndexEnd = 23 // Trailer 2 has fewer cameras, so we set a different end condition
